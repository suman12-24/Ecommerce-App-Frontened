...
import TrackOrderDetails from '../Screens/TrackOrderDetails';
    ...
    return (
      <Stack.Navigator>
        ...
        <Stack.Screen
          ...
          options={{ headerShown: false }}
        />
        <Stack.Screen name='TrackOrderDetails'
  ...
  const BottomTabNavigator = () => {
    return (
      <Tab.Navigator
        ...
        <Tab.Screen name={t('category')} component={CategoryStack} />
        {/* <Tab.Screen name="Search" component={SearchPlaceholder} /> */}
        <Tab.Screen name={t('cart')} component={CartStack} />
        <Tab.Screen name={t('offer')} component={OfferStack} />
        <Tab.Screen name={t('wishlist')} component={WishlistStack} />
      </Tab.Navigator>
    );
  };
