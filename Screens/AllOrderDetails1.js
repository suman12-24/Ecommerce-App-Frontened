    ...
    if (loading) {
        return (
            <View style={styles.loadingContainer}>
                <ActivityIndicator size="large" color="#0da386" />
    ...
    return (
        <ScrollView style={styles.container}>
            <View style={styles.header}>
                ...
                <Text style={styles.headerSubtitle}>Track your recent orders</Text>
            </View>
            ...
            {orders.map((order, orderIndex) => (
                ...
                >
                        ...
                        >
                            <View style={styles.productImageContainer}>
                                ...
                                {order.totalItems > 1 && (
                                    <View style={styles.moreBadge}>
                                        <Text style={styles.moreBadgeText}>+{order.totalItems - 1} more</Text>
                                    </View>
                                )}
                            </View>
                            ...
                            <View style={styles.productDetails}>
                                ...
                                <View style={{ marginTop: 3, marginBottom: 2 }}>
                                    <Text style={{ fontSize: 14, fontWeight: '500' }}>Total Order Quantity: {order.totalItems}</Text>
                    ...
                    <View style={styles.orderFooter}>
                        <Text style={styles.deliveryDate}>Delivery by {order.deliveryDate}</Text>
