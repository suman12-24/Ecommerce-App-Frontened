import { StyleSheet, Text, View, TextInput, TouchableOpacity, ScrollView, Alert, SafeAreaView, StatusBar, ActivityIndicator } from 'react-native'
    ...
    const handleSubmit = async () => {
        try {
            ...
            if (response.data.success) {
                Alert.alert(`${t('sucess')}`, `${t('addressAddedSucess')}`)
                navigationName ?
                ...
                <View style={styles.formContainer}>
                    <View style={styles.header}>
                        <View style={styles.iconCircle}>
                            <Icon name="location-on" size={36} color="#fff" />
                        </View>
                        <Text style={styles.title}>{t('addNewAddress')}</Text>
                        <Text style={styles.subtitle}>{t('fillDeliveryAddress')}</Text>
                    </View>
                        ...
                        >
                            {isLoading ? (
                                ...
                                <>
                                    ...
                                    <Text style={styles.buttonText}>{t('saveAddress')}</Text>
                                </>
                            )}
                        </TouchableOpacity>
                    </View>
