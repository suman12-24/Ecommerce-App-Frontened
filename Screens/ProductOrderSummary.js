...
const ProductOrderSummary = () => {
  ...
  //   // Check if COD is selected before proceeding
  //   if (!isCodSelected) {
  //     Alert.alert(t('paymentRequired'), t('selectCashOnDelivery'));
  //     return;
  //   }
  ...
  //       payment_method: 'COD', // Add payment method to payload
  //       cart: cart,
  //     };
  ...
  //     }
  //   } catch (error) {
  //     Alert.alert(t('errorOccurred'), t('pleaseTryAgain'));
  //   } finally {
  //     setLoading(false);
  //   }
  // };
  ...
  const handlePlaceOrder = async () => {
    ...
    try {
      ...
      const response = await axiosInstance.post(
        '/Suhani-Electronics-Backend/f_checkout_cod.php',
        payload,
      );
    ...
    <View style={styles.container}>
      <ScrollView
        ...
        <View style={styles.pageContainer}>
          ...
          <View style={styles.sectionContainer}>
            <View style={styles.sectionHeaderRow}>
              <MaterialIcons name="payment" size={20} color="#0ba893" />
            ...
            >
              <View style={styles.radioContainer}>
                <View style={styles.radioOuter}>
                  {isCodSelected && <View style={styles.radioInner} />}
                </View>
                <View style={styles.paymentMethodDetails}>
                  <Text style={styles.paymentMethodTitle}>{t('cashOnDelivery')}</Text>
                  <Text style={styles.paymentMethodDesc}>{t('payWhenOrderArrives')}</Text>
                </View>
              </View>
            </TouchableOpacity>
          </View>
        ...
        {loading ? (
          ...
          <TouchableOpacity
            style={[
              ...
              !isCodSelected && styles.disabledButton,
            ]}
            ...
            <Text
              style={[
                styles.placeOrderButtonText,
                !isCodSelected && styles.disabledButtonText
              ]}>
              {t('makePayment')}
            </Text>
          </TouchableOpacity>
